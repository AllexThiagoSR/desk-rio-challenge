...
queueRoutes.patch("/queue/:queueId/activate-distribution", QueueController.activateDistribution);

queueRoutes.patch("/queue/:queueId/deactivate-distribution", QueueController.deactivateDistribution);
